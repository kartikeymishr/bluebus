package com.kartikeymishr.bluebusbackend.exception;

import com.kartikeymishr.bluebusbackend.config.PropertiesConfig;
import org.springframework.beans.factory.annotation.Autowired;

import java.text.MessageFormat;
import java.util.Optional;

public class BluebusException {

    private static PropertiesConfig propertiesConfig;

    @Autowired
    public BluebusException(PropertiesConfig propertiesConfig) {
        BluebusException.propertiesConfig = propertiesConfig;
    }
